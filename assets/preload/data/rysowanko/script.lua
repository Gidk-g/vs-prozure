function onCreatePost()
    ...
    makeGraphic('bgThing', 1280, 250, '000000')
    ...
    makeLuaText('songText', "Wipek - Rysowanko", 400, getProperty('bgThing.x') + 180, 320)
...
function onSongStart()
    ...
    doTweenX('bgThingTextBlebe', 'Icon', 300, 0.6, 'linear')
